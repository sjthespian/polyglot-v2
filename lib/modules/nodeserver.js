 ...
 /* ======================================================================= */
  ...
  async addns(data) {
    ...
    try {
      ...
      newNodeServer = await NodeServer.findOneAndUpdate({ profileNum: data.profileNum }, nsData, { upsert: true, setDefaultsOnInsert: true, new: true, lean: true })
      ...
      logger.error(err.stack)
      if (newNodeServer) {
        if (newNodeServer.isConnected) {
          await newNodeServer.remove()
        }
